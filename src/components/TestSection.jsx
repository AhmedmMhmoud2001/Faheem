                    ...
                    >
                        {stats.map((stat, idx) => {
                            ...
                            return (
                                <SwiperSlide key={idx}>
                                    <div
                                        className={`rounded-3xl p-2 flex ${isRtl ? 'flex-row-reverse' : 'flex-row'} items-center justify-center group hover:bg-yellow-400 transition-all duration-300 bg-white shadow-sm md:shadow-none`}
                                    >
                ...
                <div className="bg-white rounded-[2.5rem] p-6 md:p-10 border border-slate-100 flex flex-col lg:flex-row-reverse items-center gap-8 lg:gap-14">
                    ...
                    <div className="flex-1 w-full">
                        <div className="rounded-[2rem] overflow-hidden aspect-video lg:aspect-4/3 relative group">
                            ...
                            <div className="absolute inset-0 bg-yellow-400/5 group-hover:bg-transparent transition-all" />
                        </div>
                    </div>
                </div>
            </Container>
